...
Type.prototype.extend = function(type) {
  ...
  type.validators = type.validators.concat(this.validators);
  type.casters = type.casters.concat(this.casters);
  type.getters = type.getters.concat(this.getters);
  type.setters = type.setters.concat(this.setters);
  type.requiredValidator = this.requiredValidator;
  return type;
};
